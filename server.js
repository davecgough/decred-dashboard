...
if (env == "production"){
  ...
  new CronJob("0 0,15,30,45 * * * *", updatePrices, null, true, "Europe/Rome");
  new CronJob("0 5,20,35,50 * * * *", updateMarketCap, null, true, "Europe/Rome");
  new CronJob("0 10,25,40,55 * * * *", updateForexRates, null, true, "Europe/Rome");
} else {
  // Dev timings
  new CronJob("*/15 * * * * *", updateStats, null, true, "Europe/Rome");
  new CronJob("*/15 * * * * *", updatePrices, null, true, "Europe/Rome");
  new CronJob("*/15 * * * * *", updateMarketCap, null, true, "Europe/Rome");
